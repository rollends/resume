...
\small{\url{rs2dsouz@uwaterloo.ca}~\textbullet~\url{github.com/rollends} }\\
...
\section*{Education}
\begin{adjustwidth}{1em}{0em}%
    \entryGeneral{Expected 2019/08}{MASc\quad\emph{(Pursuing Actively Full-Time)}}{University of Waterloo}{
        Current Student supervised by Prof. Christopher Nielsen.
    }

    \entryGeneral{2017/07}{\textbf{BSE}}{University of Waterloo}{
